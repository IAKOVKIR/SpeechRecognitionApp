...
import com.example.audiochatbot.administrator.discard_items.DiscardItemStoreFragmentDirections
            ...
            storeId?.let {
                when (args.directionId) {
                    ...
                    2 -> {
                        ...
                        this.findNavController().navigate(DiscardItemStoreFragmentDirections.actionDiscardItemStoreToCashReportFragment(userId, storeId, businessId))
                    }
                }
