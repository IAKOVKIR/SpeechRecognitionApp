...
/**
 * ViewModel for EmployeeDiscardItemListFragment.
 *
 ...
 */
class EmployeeDiscardItemListViewModel(val userId: Int, val storeId: Int, val dataSource: UserDao) : ViewModel() {
     ...
     * a [EmployeeDiscardItemListViewModel] update the UI after performing some processing.
     */
    private val uiScope = CoroutineScope(Dispatchers.Main + viewModelJob)

    val discardedItems = database.getDiscardedItemsWithStoreAndUserId(userId, storeId)
