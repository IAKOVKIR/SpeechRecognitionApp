 ...
 */
class AssignedProductsFragment : Fragment(), TextToSpeech.OnInitListener {

    private var textToSpeech: TextToSpeech? = null
    private lateinit var testViewModel: AssignedProductsViewModel
    ...
    override fun onCreateView(
        ...
        testViewModel.navigateToAssignProducts.observe(viewLifecycleOwner, { result ->
            if (result != null) {
                this.findNavController().navigate(AssignedProductsFragmentDirections.actionAssignedProductsToAssignProducts(adminId!!, storeId!!, businessId!!))
