...
import com.example.audiochatbot.databinding.FragmentDiscardItemListRecyclerViewAdapterBinding
import kotlinx.coroutines.CoroutineScope
import kotlinx.coroutines.Dispatchers
import kotlinx.coroutines.launch
import kotlinx.coroutines.withContext

class DiscardedItemListRecyclerViewAdapter(private val userDao: UserDao) : ListAdapter<DiscardedItem,
        DiscardedItemListRecyclerViewAdapter.ViewHolder>(
    DiscardItemListDiffCallback()
) {
    ...
    class ViewHolder private constructor(val binding: FragmentDiscardItemListRecyclerViewAdapterBinding, val context: Context)
        ...
        companion object {
            fun from(parent: ViewGroup): ViewHolder {
                ...
                val binding = FragmentDiscardItemListRecyclerViewAdapterBinding.inflate(layoutInflater, parent, false)
...
class DiscardItemListDiffCallback : DiffUtil.ItemCallback<DiscardedItem>() {
